...
Each of these can stand as its own category, so they are combined into the General category.
...
The hand has a triplet or quartet of one's own seat honor or the dragons.

#### Pure Straight: 4 points

The hand has the three sequences "123", "456", and "789" in the same suit.

#### All Triplets: 4 points

The hand has one pair and four triplets or quartets, with no sequence.
...
The hand is composed entirely of simple tiles.

#### Common Outside: 4 points

Every meld and the pair in the hand contains an orphan tile.

#### Perfect Outside: 6 points

Every meld and the pair in the hand contains a terminal tile.

#### Common Terminals: 12 points

The hand is composed entirely of orphan tiles.

#### Perfect Terminals: 32 points

The hand is composed entirely of terminal tiles.

## Single-Suit category ##

The hand is composed entirely of one suit, or of that suit mixed with honor tiles.

#### Common Flush: 4 points

The hand is composed of number tiles of a single suit plus honor tiles.

#### Perfect Flush: 8 points

The hand is composed entirely of number tiles of a single suit.

#### All Honors: 32 points
...
The hand has melds of the same number across all three suits.

#### Mixed Sequences: 3 points

Three sequences of the same numbers across the three suits.

#### Mixed Triplets: 12 points

Three triplets or quartets of the same number across the three suits.

## Identical-Sequences category ##

The hand has two or more completely identical sequences.

#### Doubled Sequence: 1 point

The hand has two completely identical sequences.

#### Two Doubled Sequences: 8 points

The hand has two Doubled Sequences.

#### Tripled Sequence: 12 points
...
## Concealed-Triplets category ##

The hand has multiple concealed triplets or concealed quartets. If a concealed triplet becomes an open meld through a claimed kong, it no longer counts as a concealed triplet.

#### Two Concealed Triplets: 1 point

The hand has two concealed triplets or quartets.

#### Three Concealed Triplets: 3 points

The hand has three concealed triplets or quartets.

#### Four Concealed Triplets: 4 points

The hand has four concealed triplets or quartets.

## Consecutive-Triplets category ##

The hand has triplets or quartets of consecutive numbers in the same suit.

#### Three Consecutive Triplets: 4 points

The hand has three triplets or quartets of consecutive numbers in the same suit.

#### Four Consecutive Triplets: 16 points

The hand has four triplets or quartets of consecutive numbers in the same suit.

## Quartets category ##

The hand has quartets, each formed from four tiles of the same kind through a kong.

#### One Quartet: 1 point

The hand has one quartet.

#### Two Quartets: 4 points

The hand has two quartets.

#### Three Quartets: 12 points

The hand has three quartets.

#### Four Quartets: 32 points

The hand has four quartets.
